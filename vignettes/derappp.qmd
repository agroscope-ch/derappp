...
subtitle: Revision 7 September 2026
...
In the package, there is also a list of chent objects that can be used to plot
any of the structures as shown in @fig-tebufenozide below.
...
HS), the corresponding model parameters are recorded, and a substitute
half-life value is calculated for comparison purposes (DT90/3.32 for FOMC, and
ln(2)/k$_2$ for DFOP and HS).
