...
```
    ...
    5 Cyprodinil         NA    0.00049     298. <NA>   j.efsa.2006.51r    39 Midpoi…
...
```
    ...
    12 Cyprodinil         NA        15     298.  9    <NA>   j.efsa.2…    39 HPLC m…
...
are recorded, and a substitute half-life value is calculated for
comparison purposes (DT90/3.32 for FOMC, and ln(2)/k$`_2`$ for DFOP and
HS).
...
```
    ...
    # A tibble: 1,504 × 7
     ...
     3 1-Naphthylacetic acid Cyprinus carpio              4 morta… >        82 j.ef…
     4 1-Naphthylacetic acid Oncorhynchus mykiss …        4 morta… =        75 j.ef…
     5 1-Naphthylacetic acid Oncorhynchus mykiss …        4 morta… =        37 j.ef…
     6 1-Naphthylacetic acid Oncorhynchus mykiss …       28 growth =        10 j.ef…
