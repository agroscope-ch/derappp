...
In case you wonder how to install a version \<= 1.0.11 of the
`DiagrammeR` package (we list this as “Suggests:” in the DESCRIPTION),
with the `pak` installed it is as easy as
