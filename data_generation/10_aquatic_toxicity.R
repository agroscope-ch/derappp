...
check_and_add("amisulbrom_aquatic_toxicity.xlsx")
check_and_add("azadirachtin_aquatic_toxicity.xlsx")
check_and_add("azoxystrobin_aquatic_toxicity.xlsx")
check_and_add("boscalid_aquatic_toxicity.xlsx")
check_and_add("bupirimate_aquatic_toxicity.xlsx")
check_and_add("captan_aquatic_toxicity.xlsx")
check_and_add("chlorpyrifos-methyl_aquatic_toxicity.xlsx")
check_and_add("copper_aquatic_toxicity.xlsx")
check_and_add("cyazofamid_aquatic_toxicity.xlsx")
check_and_add("cyflufenamid_aquatic_toxicity.xlsx")
check_and_add("cymoxanil_aquatic_toxicity.xlsx")
check_and_add("cyprodinil_aquatic_toxicity.xlsx")
check_and_add("difenoconazole_aquatic_toxicity.xlsx")
check_and_add("dimethomorph_aquatic_toxicity.xlsx")
check_and_add("diquat_aquatic_toxicity.xlsx")
check_and_add("dithianon_aquatic_toxicity.xlsx")
check_and_add("diuron_aquatic_toxicity.xlsx")
check_and_add("emamectin_benzoate_aquatic_toxicity.xlsx")
check_and_add("ethephon_aquatic_toxicity.xlsx")
check_and_add("fatty_acids_aquatic_toxicity.xlsx")
check_and_add("fenoxaprop-P-ethyl_aquatic_toxicity.xlsx")
check_and_add("flonicamid_aquatic_toxicity.xlsx")
check_and_add("fluazinam_aquatic_toxicity.xlsx")
check_and_add("fludioxonil_aquatic_toxicity.xlsx")
check_and_add("flufenacet_aquatic_toxicity.xlsx")
check_and_add("fluopicolide_aquatic_toxicity.xlsx")
check_and_add("flutolanil_aquatic_toxicity.xlsx")
check_and_add("folpet_aquatic_toxicity.xlsx")
check_and_add("gibberellic_acid_aquatic_toxicity.xlsx")
check_and_add("gibberellins_aquatic_toxicity.xlsx")
check_and_add("glufosinate_aquatic_toxicity.xlsx")
